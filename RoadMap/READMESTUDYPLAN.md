<h1 align="center">DEPI Data Science Roadmap</h1>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ul>
                    <h3>🚀 Base resources</h3>
                    <li><a href="https://youtu.be/uu8um0JmYA8?si=vTl5MbjQzK0-phdi">Feature Engineering for Machine Learning in Python</a> Feature Engineering Full Course — in 1 Hour: شرح شامل للمبتدئين، كويس لو عايزة حاجة سريعة تفهمي بيها الأساسيات كلها. </li>
                    <li><a href="https://youtu.be/1wunZOOG-pM?si=uVN8fkiozXWhelS2">Complete Feature Engineering Crash Course 2024 — Learn feature engineering in just 15 minutes: لو ضيق وقتك، الفيديو ده يلخّصلك الموضوع بسرعة. </li>
                    <li><a href="https://youtu.be/vJnEW4ZsUHQ?si=n3QlbO1m7-QO6Pe2">Feature Engineering in Data Science & Machine Learning: واحد من الفيديوهات اللي بيشرح ازاي تطبقي Feature Engineering في مشاريع ML حقيقية. </li>
